...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1868888b779c80eaa427fc1a0c81dc33,en:1868888b779c80eaa427fc1a0c81dc33',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Leo Chien', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Astrophotographer | Robotics Engineer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://leochien1110.github.io/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion Blog, Notion Blog', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi, this is Leo Chien. Welcome to my blog! I am an astrophotography enthusiast and robotics engineer. Will share my journey and insights here!',
